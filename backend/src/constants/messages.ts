export const messages = {
  ...
  complaints: {
    notFound: '投诉不存在',
    alreadyHandled: '该投诉已处理，不能重复受理或驳回',
    rejected: '投诉已驳回',
    resolved: '投诉已受理，关联服务记录已作废',
    handleFailed: '处理投诉失败',
    recordRequired: '投诉必须绑定具体的服务记录',
    recordNotFound: '被投诉的服务记录不存在',
    recordOwnerMismatch: '服务记录不属于该志愿者',
    recordOutOfRange: '仅可投诉近七天内发生的服务记录',
    recordAlreadyComplained: '该服务记录此前已被投诉，不能重复投诉',
    recordAlreadyVoid: '该服务记录已作废，不能再次投诉',
    duplicatePending: '该服务记录已存在待处理投诉',
    createFailed: '创建投诉失败',
  },
  admin: {
